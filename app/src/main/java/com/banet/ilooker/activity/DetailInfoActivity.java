...
public class DetailInfoActivity extends BaseActivity<ActivityDetailInfoBinding> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mNoti104 != null)
            ...
            Toast.makeText(DetailInfoActivity.this, "공지번호가 존재하지 않습니다.", Toast.LENGTH_SHORT).show();
            finish();
        }
    ...
    private void request110GeneralNoticedetail(String NoticeNumber) {
        ...
        showProgress("");
        DataInterface.getInstance().getApi110GeneralNotice(DetailInfoActivity.this, params, new DataInterface.ResponseCallback<ResponseData<Object>>() {
            @Override
            ...
            public void onFailure(Throwable t) {
                Toast.makeText(DetailInfoActivity.this, "공지내역 수신 실패. 관리자에게 문의하십시요.", Toast.LENGTH_SHORT).show();
            }
