...
public class AiLookerCustomDialog extends Dialog {
    ...
    private AiLookerCustomDialog dialog = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ailooker_custom_dlg);
    ...
    public AiLookerCustomDialog(Context context, String title, String content, String btnTitle,
    ...
    public AiLookerCustomDialog(Context context, String title, String content, String leftBtnTitle, String rightBtnTitle,
    ...
    // 클릭버튼이 확인과 취소 두개일때 생성자 함수로 이벤트를 받는다
    public AiLookerCustomDialog(Context context, String title, Spanned content, String leftBtnTitle, String rightBtnTitle,
                                View.OnClickListener leftListener,
                                View.OnClickListener rightListener, boolean isThemePink) {
        super(context, android.R.style.Theme_Translucent_NoTitleBar);
